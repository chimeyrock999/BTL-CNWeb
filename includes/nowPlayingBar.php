...
function getIdOfPlayingSongs(){
	return audioElement.currentlyPlaying.id;
}
	// <?php
	// 	$liked = false;
	// 	$songId=getIdOfPlayingSongs();
	// 	$username=$userLoggedIn->getUsername();
	// 	$query=mysqli_query($con,"SELECT songid FROM likedsongs WHERE songId='$songId' AND owner='$username'");
